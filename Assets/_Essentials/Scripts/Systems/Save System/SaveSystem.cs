...
public sealed class SaveSystem
{
    ...
    public static string GetSavePath() => Path.Combine(Application.persistentDataPath, "SavedGame.json");

    //Editor only functions
#if UNITY_EDITOR

    //For Opening SaveData file => Shortcut key (Ctrl or Cmd) + Shift + j
    [UnityEditor.MenuItem("Talha/Save System/Open Save File %#j")]
    ...
    [UnityEditor.MenuItem("Talha/Save System/Reset Save Data %#r")]
